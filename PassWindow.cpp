...
void PassWindow::apply_style()
{
	if (true)//(this->theme == Theme::Bright)
	{
		...
		//languages
		this->languageCB->setStyleSheet("QComboBox{ border: 0px; background-color: #FCFCFA; color: #0A0905; text-align: right; } QComboBox::down-arrow{ image: url(images/down_arrow.svg); } QComboBox::down-arrow:on{ top: 5px; left: 5px; } QComboBox::focus{ background-color: #F2F2F0; } QComboBox:hover{ background-color: #F2F2F0; }");
	...
	else
	{
		...
		//languages
		this->languageCB->setStyleSheet("QComboBox{ border: 0px; background-color: #262625; color: #FCFCFA; text-align: right; } QComboBox::down-arrow{ image: url(images/down_arrow_dark.svg); } QComboBox::down-arrow:on{ top: 5px; left: 5px; } QComboBox::focus{ background-color: #F2F2F0; } QComboBox:hover{ background-color: #F2F2F0; }");
